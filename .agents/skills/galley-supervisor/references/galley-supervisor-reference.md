<!--
This file is adapted from docs/integrations/galley-supervisor-reference.md
and shipped inside the galley-supervisor Codex / Agents skill for advanced
command and workflow details.
