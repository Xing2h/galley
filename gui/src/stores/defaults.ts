...
export const DEFAULT_RUNTIME_INFO: RuntimeInfo = {
  ...
  bridgePid: 48213,
  gaCommit: "5f46b43816d6298f5e1d34c7076ea31f875b7810",
  // Matches 5f46b438's actual `git log -1 --format=%cI`. Bump alongside
  ...
  // event in production.
  gaCommitDate: "2026-06-02T10:10:20+08:00",
  gaBaseline: "5f46b43816d6298f5e1d34c7076ea31f875b7810",
