...
const zhCopy = {
  ...
  updates: {
    ...
    upToDate: "已是最新版本。",
    foundPreparing: "发现新版本，正在后台准备更新",
    preparing: "发现新版本，正在后台准备更新",
    ready: "新版本已下载，重启 Galley 生效",
    readyAfterTasks: "新版本已下载，当前任务结束后再重启",
...
const enCopy: AppCopy = {
  ...
  updates: {
    ...
    foundPreparing: "New version found. Preparing it in the background.",
    preparing: "New version found. Preparing it in the background.",
    ready: "New version downloaded. Restart Galley to apply it.",
    readyAfterTasks:
      "New version downloaded. Restart after the current task finishes.",
    foundAfterTasks:
