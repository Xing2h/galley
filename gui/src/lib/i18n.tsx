...
const zhCopy = {
  ...
  browserControl: {
    ...
    close: "关闭浏览器控制设置",
    stepPrepare: "准备 tmwd_cdp_bridge 文件夹和配置",
    stepPrepareReady: "已准备好，可以安装",
    stepPrepareFailed:
      "Galley 未能准备 tmwd_cdp_bridge。请重试，或重新安装 Galley。",
    stepOpenExtensions: "在 Chrome、Edge 或其他 Chromium 浏览器里打开扩展页，并开启开发者模式",
    stepInstall: "把 tmwd_cdp_bridge 文件夹拖到扩展页",
    stepInstallHint: "拖拽无效时，点击「加载已解压的扩展程序」并选择 tmwd_cdp_bridge 文件夹。",
    openGuide: "图文指南",
    openGuideTitle: "打开官方 Chrome 图文安装步骤",
    openGuideFallback: (url: string) =>
      `无法自动打开图文指南，请访问 ${url}`,
    stepTest: "在同一浏览器保留一个普通网页标签页，然后回到 Galley 测试连接",
    preparingPath: "正在准备路径…",
    retryPrepare: "重新准备",
    showFolder: "显示文件夹",
    showFolderFallback: "无法自动显示文件夹，请复制路径后在 Finder 中打开。",
    copyPath: "复制路径",
    copied: "已复制",
    openChrome: "打开 Chrome 扩展页",
    openEdge: "打开 Edge 扩展页",
    ...
    later: "稍后再说",
    runDemo: "试用浏览器控制",
    runDemoTitle: "让 Galley 打开浏览器并搜索天气",
    demoConnectionFailed: "浏览器扩展未连接，暂时不能开始演示。",
    demoPrompt:
  ...
  settings: {
    ...
    models: {
      ...
      loading: "加载中...",
      keyNeedsResaveShort: "需要 Key",
      keyStatusUnknownShort: "Key 状态未知",
  ...
  updates: {
    ...
    retry: "重试",
    checking: "正在检查更新...",
    devNoChannel: "此构建未连接更新通道；Dev 模式下这是预期状态。",
    upToDate: "已是最新版本。",
    found: (version: string) => `发现 v${version}，可后台下载并准备更新。`,
    downloading: "正在后台下载并准备更新...",
    ready: (version: string) => `v${version} 已准备好，重启后生效。`,
    readyAfterTasks: (version: string) =>
      `v${version} 已准备好；当前任务结束后再重启。`,
    foundAfterTasks: (version: string) =>
...
const enCopy: AppCopy = {
  ...
  browserControl: {
    ...
    stepPrepare: "Prepare the tmwd_cdp_bridge folder and config",
    stepPrepareReady: "Ready to install",
    stepPrepareFailed:
      "Galley could not prepare tmwd_cdp_bridge. Try again, or reinstall Galley.",
    stepOpenExtensions:
      "Open the extensions page in Chrome, Edge, or another Chromium browser, then enable Developer mode.",
    stepInstall: "Drag the tmwd_cdp_bridge folder onto the extensions page",
    stepInstallHint:
      'If drag-and-drop does not work, choose "Load unpacked" and select the tmwd_cdp_bridge folder.',
    ...
    stepTest:
      "Keep a normal webpage tab open in the same browser, then return to Galley and test the connection",
    ...
    copyPath: "Copy path",
    copied: "Copied",
    openChrome: "Open Chrome extensions",
    openEdge: "Open Edge extensions",
    ...
    testing: "Testing",
    later: "Later",
    runDemo: "Try Browser Control",
    runDemoTitle: "Let Galley open the browser and search for weather",
    demoConnectionFailed:
      "The browser extension is not connected, so the demo cannot start yet.",
    demoPrompt:
  ...
  updates: {
    ...
    devNoChannel:
      "This build is not connected to an update channel; expected in dev mode.",
    upToDate: "Galley is up to date.",
    found: (version) =>
      `Found v${version}; it can be downloaded and prepared in the background.`,
    downloading: "Downloading and preparing the update in the background...",
    ready: (version) => `v${version} is ready. Restart to apply it.`,
    readyAfterTasks: (version) =>
      `v${version} is ready. Restart after the current task finishes.`,
    foundAfterTasks: (version) =>
      `Found v${version}. Galley can prepare it after the current task finishes.`,
