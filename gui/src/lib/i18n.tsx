...
const zhCopy = {
  ...
  composer: {
    ...
    goalConfirmBody: "让 Galley 在后台持续推进这个目标，完成后汇总结论。",
    ...
    goalAgentCountCustom: "自定义",
    goalAgentCountCustomInput: "自定义 Agent 数量",
    goalAgentCountUnit: "个",
    goalAgentCountRange: "3-9 个",
...
const enCopy: AppCopy = {
  ...
  composer: {
    ...
    goalConfirmBody:
      "Let Galley keep working in the background and summarize the result when it finishes.",
    ...
    goalAgentCountCustom: "Custom",
    goalAgentCountCustomInput: "Custom Agent count",
    goalAgentCountUnit: "Agents",
    goalAgentCountRange: "3-9 Agents",
