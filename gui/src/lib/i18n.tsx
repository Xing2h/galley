...
const zhCopy = {
  ...
  settings: {
    ...
    models: {
      ...
      keyVerified: "Key 已验证",
      keySaved: "Key 已保存",
      keyNeedsResaveShort: "需要重新保存 Key",
    ...
    agent: {
      ...
      discoveryDescription:
        "Galley 启动时把 CLI 二进制的绝对路径写到这个文件。Supervisor SOP 第一步读它来定位 galley。",
      agentSop: "Agent SOP",
      sopDescription:
        "复制这份 SOP，发给你信任的 Agent。它就能帮你查看、创建和管理 Galley 对话。",
      sopLoading: "加载中…",
      sopCopy: "复制 SOP",
      sopCopying: "复制中…",
      sopCopied: "已复制",
      ...
      cliShortcut: "命令行快捷入口",
      cliDescription:
        "可选。安装后，你和脚本都可以直接在终端使用 galley。Agent SOP 不依赖它。",
      pathInstallHintMac: "macOS 会请求一次系统权限。",
      pathUnsupportedWindows:
        "Windows 一键安装命令稍后支持。Agent SOP 不依赖它。",
      pathUnsupportedGeneric: "当前平台暂不支持一键安装。Agent SOP 不依赖它。",
      pathInstalled: "已安装：",
      pathBusy: "处理中…",
      pathRemove: "移除命令",
      pathReplace: "替换命令",
...
const enCopy: AppCopy = {
  ...
  settings: {
    ...
    models: {
      ...
      keySaved: "Key saved",
      keyNeedsResaveShort: "Key needs to be saved again",
    ...
    agent: {
      ...
      discoveryFile: "Discovery file",
      discoveryDescription:
        "Galley writes the absolute CLI binary path here on startup. Supervisor SOP reads it first to locate galley.",
      agentSop: "Agent SOP",
      sopDescription:
        "Copy this SOP for a trusted Agent. It can then inspect, create, and manage Galley conversations.",
      sopLoading: "Loading...",
      sopCopy: "Copy SOP",
      sopCopying: "Copying...",
      sopCopied: "Copied",
      ...
      cliDescription:
        "Optional. After installing it, you and your scripts can run galley directly from the terminal. Agent SOP does not depend on it.",
      pathInstallHintMac: "macOS will ask for system permission once.",
      pathUnsupportedWindows:
        "One-click command installation on Windows is coming later. Agent SOP does not depend on it.",
      pathUnsupportedGeneric:
        "One-click command installation is not supported on this platform. Agent SOP does not depend on it.",
