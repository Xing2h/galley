...
const zhCopy = {
  ...
  topbar: {
    ...
    goalStatusRunning: (minutes: number | null, workers: number) =>
      minutes === null
        ? `运行中 · ${workers} 个 Agent`
        : `运行中 · 剩余 ${minutes} 分钟 · ${workers} 个 Agent`,
    goalStatusWrapping: (workers: number) => `整理结果中 · ${workers} 个 Agent`,
    goalStatusReady: (workers: number) => `结果已就绪 · ${workers} 个 Agent`,
    goalStatusFailed: (workers: number) => `运行失败 · ${workers} 个 Agent`,
    goalStatusStopped: (workers: number) => `已停止 · ${workers} 个 Agent`,
    goalReadyDescription: "结果已整理完成，打开后查看总结。",
    goalFailedDescription: "Goal 未能完成，打开后查看详情。",
    goalRunningDescription: "Galley 正在后台推进这个目标。",
    openGoal: "查看进展",
    openGoalResult: "查看结果",
...
const enCopy: AppCopy = {
  ...
  topbar: {
    ...
    goalTooltip: "Galley Goal",
    goalStatusRunning: (minutes, workers) =>
      minutes === null
        ? `Running · ${workers} Agents`
        : `Running · ${minutes}m left · ${workers} Agents`,
    goalStatusWrapping: (workers) => `Wrapping · ${workers} Agents`,
    goalStatusReady: (workers) => `Result ready · ${workers} Agents`,
    goalStatusFailed: (workers) => `Failed · ${workers} Agents`,
    goalStatusStopped: (workers) => `Stopped · ${workers} Agents`,
    goalReadyDescription: "The result is ready. Open it to read the summary.",
    goalFailedDescription: "The Goal did not complete. Open it for details.",
    goalRunningDescription: "Galley is working on this Goal in the background.",
    openGoal: "View progress",
    openGoalResult: "Open result",
    viewGoalDetails: "View details",
    openGoalProject: "Project",
    copyGoalStatus: "Copy command",
    stopGoal: "Stop",
