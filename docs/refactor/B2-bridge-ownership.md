...
```
Cursor:   T2.1  (M1 done — RunnerManager scaffold + 35 tests passing; next: Tauri command wrappers)
Status:   🚧 M1 COMPLETE · M2-M7 pending
Started:  2026-05-19
Last touch: 2026-05-19 — M1 T1.1-T1.19 ship, 35 tests (26 lib + 9 integration) pass
