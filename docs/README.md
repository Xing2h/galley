...
| Touch product/UX specs | [product specs](./specs/README.md) |
...
- [product specs](./specs/README.md): focused product and UX specifications
  that remain useful as source material after implementation.
