...
class GenericAgent:
    def __init__(self):
        ...
        self.log_path = state_path('temp', 'model_responses', f'model_responses_{int(time.time()*1e6)%1000000:06d}.txt')
...
if __name__ == '__main__':
    ...
    if args.task and not args.nobg:
        ...
        d = state_path('temp', args.task); os.makedirs(d, exist_ok=True)
    ...
    if args.task:
        ...
        agent.task_dir = d = state_path('temp', args.task); nround = ''
        ...
        while True:
            ...
            log_dir = state_path('temp', 'reflect_logs'); os.makedirs(log_dir, exist_ok=True)
