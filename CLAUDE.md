...
参考 prototype 在 `docs/design-handoff/`（design agent 出品的 5 张关键界面静态实现，目录在 rebrand 后从 `GenericAgent Workbench-handoff/` rename），实现各组件时对照视觉。
